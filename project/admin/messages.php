...
if(isset($_POST['delete'])){
   ...
   if($verify_delete->rowCount() > 0){
      ...
      $success_msg[] = 'Pesan dihapus!';
   }else{
      $warning_msg[] = 'Pesan sudah dihapus!';
   }
...
<section class="grid">
   ...
   <div class="box">
      ...
      <form action="" method="POST">
         ...
         <input type="submit" value="delete message" onclick="return confirm('hapus pesan ini?');" name="delete" class="btn">
      </form>
   </div>
   <?php
      }
   ...
   <div class="box" style="text-align: center;">
      ...
      <a href=".php" class="btn">Kembali</a>
   </div>
   <?php
      }
   ?>

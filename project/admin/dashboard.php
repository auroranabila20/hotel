...
<section class="dashboard">
   ...
   <div class="box">
      ...
      <a href="update.php" class="btn">Perbarui Profile</a>
   </div>
   ...
   <div class="box">
      ...
      <p>Total Bookings</p>
      <a href="bookings.php" class="btn">Lihat Tiket</a>
   </div>
   ...
   <div class="box">
      ...
      <h3><?= $count_admins; ?></h3>
      <p>Total Admins</p>
      <a href="admins.php" class="btn">Lihat Pengelola</a>
   </div>
   ...
   <div class="box">
      <h3>Pilihan Cepat</h3>
      <p>Masuk atau Registrasi</p>
      <a href="login.php" class="btn" style="margin-right: 1rem;">Masuk</a>
      <a href="register.php" class="btn" style="margin-left: 1rem;">Registrasi</a>
   </div>

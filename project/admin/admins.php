...
<section class="grid">
   ...
   <h1 class="heading">Pengelola</h1>

   <div class="box-container">

   <div class="box" style="text-align: center;">
      <p>Buat Admin Baru</p>
      <a href="register.php" class="btn">Registrasi Sekarang</a>
   </div>
   ...
   <div class="box" <?php if( $fetch_admins['name'] == 'admin'){ echo 'style="display:none;"'; } ?>>
      ...
      <form action="" method="POST">
         ...
         <input type="submit" value="delete admins" onclick="return confirm('hapus admin ini?');" name="delete" class="btn">
      </form>
   </div>
   <?php
      }

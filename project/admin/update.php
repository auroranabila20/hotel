...
if(isset($_POST['submit'])){
   ...
   if(!empty($name)){
      ...
      if($verify_name->rowCount() > 0){
         ...
         $success_msg[] = 'Nama pengguna diperbarui!';
      }
   }
   ...
   if($old_pass != $empty_pass){
      if($old_pass != $prev_pass){
         ...
         if($new_pass != $empty_pass){
            ...
            $success_msg[] = 'Kata Sandi diperbarui!';
         }else{
            $warning_msg[] = 'Mohon masukkan kata sandi baru!';
         }
      }
   }
...
<section class="form-container">
   ...
   <form action="" method="POST">
      ...
      <input type="password" name="c_pass" placeholder="konfirmasi kata sandi baru" maxlength="20" class="box" oninput="this.value = this.value.replace(/\s/g, '')">

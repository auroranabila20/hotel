...
if(isset($_POST['delete'])){
   ...
   if($verify_delete->rowCount() > 0){
      ...
      $success_msg[] = 'Sewa kamar dihapus!';
   }else{
      $warning_msg[] = 'Sewa kamar berhasil dihapus!';
   }
...
<section class="grid">
   ...
   <div class="box">
      ...
      <form action="" method="POST">
         ...
         <input type="submit" value="delete booking" onclick="return confirm('Hapus Sewa ini?');" name="delete" class="btn">
      </form>
   </div>
   <?php
      }
   ...
   <div class="box" style="text-align: center;">
      <p>Sewa Kamar Tidak Ditemukan!</p>

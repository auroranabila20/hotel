...
if(isset($_POST['submit'])){
   ...
   if($select_admins->rowCount() > 0){
      ...
      $warning_msg[] = 'Nama pengguna dan kata sandi salah!';
   }
...
<section class="form-container" style="min-height: 100vh;">
   ...
   <form action="" method="POST">
      ...
      <p>Masukkan <span>Username</span> & Password <span>Admin</span></p>
      ...
      <input type="password" name="pass" placeholder="masukkan password" maxlength="20" class="box" required oninput="this.value = this.value.replace(/\s/g, '')">
      <a href="../admin/dashboard.php" class="btn">Masuk</a>
